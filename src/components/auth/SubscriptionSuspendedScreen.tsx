...
export const SubscriptionSuspendedScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#070707] text-[#e5e5e5] flex flex-col items-center justify-center p-4 sm:p-6 select-none relative overflow-y-auto">
      ...
      <div className="w-full max-w-2xl bg-[#0f0f0f] border border-rose-500/30 rounded-2xl shadow-2xl shadow-rose-950/20 overflow-hidden relative z-10 my-auto">
        {/* Header Alert Banner */}
        <div className="bg-rose-500/10 border-b border-rose-500/20 p-6 sm:p-8 text-center relative">
          ...
          <p className="text-sm text-neutral-300 max-w-lg mx-auto leading-relaxed">
            A licença de utilização desta empresa atingiu a data de validade ou foi suspensa.
            Por favor, entre em contacto diretamente com a nossa equipa para efetuar o pagamento e renovar o seu plano.
          </p>
        </div>
          ...
          <div className="p-4 bg-[#141414] border border-[#262626] rounded-xl space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs pt-1">
              <div className="p-2.5 bg-[#0a0a0a] rounded-lg border border-[#222222]">
                <span className="text-[10px] text-neutral-500 uppercase font-mono block">Plano</span>
                <span className="font-semibold text-[#c5a47e]">{subInfo.plan}</span>
              </div>

              <div className="p-2.5 bg-[#0a0a0a] rounded-lg border border-[#222222]">
                <span className="text-[10px] text-neutral-500 uppercase font-mono block">Ciclo</span>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h4 className="text-xs font-bold text-neutral-300 uppercase tracking-wider font-mono flex items-center space-x-1.5">
                ...
                <span>Contactar para Renovação Imediata</span>
              </h4>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 pt-1">
                      ...
                      <button
                        type="button"
                        onClick={() => handleCopyPhone(contact.number, contact.label)}
