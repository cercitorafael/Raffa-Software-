...
export const CashShiftModal: React.FC<CashShiftModalProps> = ({ onClose }) => {
  ...
  const [mode, setMode] = useState<'info' | 'open' | 'close' | 'sangria' | 'suprimento'>('info');
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          {closedZReport ? (
            ...
            <div className="space-y-4 text-center">
              <div className="w-12 h-12 bg-[#c5a47e]/15 text-[#c5a47e] border border-[#c5a47e]/30 rounded-full flex items-center justify-center mx-auto">
                <Unlock className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-base font-serif font-bold text-[#c5a47e]">Abertura de Turno de Caixa</h4>
                <p className="text-xs text-neutral-400">
                  Insira o Fundo de Maneio (trocos iniciais na gaveta) para iniciar as vendas.
                </p>
              </div>
              ...
              <button
                onClick={handleOpen}
                className="w-full py-3 bg-[#c5a47e] hover:bg-[#d4b896] text-black rounded-lg text-xs font-bold uppercase tracking-wider transition-all shadow-md cursor-pointer"
              >
