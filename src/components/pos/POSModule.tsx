    ...
    <div className="flex-1 flex flex-col md:flex-row h-full overflow-hidden bg-[#0a0a0a] text-[#e5e5e5]">
      ...
      <div className="w-full md:w-96 lg:w-[420px] bg-[#0d0d0d] border-l border-[#262626] flex flex-col shrink-0 shadow-2xl z-20">
        ...
        <div className="p-4 bg-[#141414] border-t border-[#262626] space-y-3">
          {/* Quick Actions (Global Discount, Open Drawer, Shift) */}
          <div className="grid grid-cols-2 gap-2 text-xs">
            <button
              onClick={() => setShowDiscountModal(true)}
              className={`flex items-center justify-center space-x-1 py-1.5 px-2 rounded-lg border text-xs font-semibold transition-colors ${
                globalDiscount > 0
            ...
            >
              ...
              <span>Desc. Global {globalDiscount > 0 ? `(${globalDiscount}%)` : ''}</span>
            </button>
            ...
            <button
              ...
              className="flex items-center justify-center space-x-1 py-1.5 px-2 bg-[#0d0d0d] border border-[#262626] hover:bg-[#1a1a1a] text-neutral-300 rounded-lg text-xs font-semibold transition-colors"
            >
              <Clock className="w-3.5 h-3.5 text-[#c5a47e]" />
              <span>Turno & Caixa</span>
            </button>
          </div>
