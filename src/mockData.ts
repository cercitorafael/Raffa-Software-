...
export const defaultInvoiceTemplates: InvoiceTemplateConfig[] = [
  {
    ...
    swiftBic: 'BIMMZMZX',
    secondaryBankName: 'BCI (Banco Comercial e de Investimentos)',
    secondaryBankIban: '000800000023489112341',
    secondaryAccountNumber: '0023489112',
    tertiaryBankName: 'Standard Bank Moçambique',
    tertiaryBankIban: '000300000928374110298',
    tertiaryAccountNumber: '9283741102',
    bankAccounts: [
      {
        id: 'bank-bim',
        bankName: 'Millennium BIM',
      ...
      },
      {
        ...
        iban: '000300000928374110298',
        accountNumber: '9283741102',
        swiftBic: 'SBICMZM0',
        isPrimary: false,
      },
      {
        id: 'bank-mpesa',
        bankName: 'M-Pesa (Vodacom Carteira Móvel)',
        iban: 'M-Pesa Titular: 84 123 4567',
        accountNumber: '841234567',
        isPrimary: false,
      },
    ],
    headerNotes: '',
...
export const initialShiftTypes: ShiftType[] = [
  {
    ...
    color: '#c5a47e',
    description: 'Jornada de trabalho legal padrão de 8 horas diárias, recomendada para comércio e atendimento com 1h de intervalo para almoço.',
    appliesTo: 'all',
  },
  {
    id: 'shift-type-6h',
    name: 'Turno Intermédio (6 Horas de Trabalho)',
    code: 'T-6H',
    durationHours: 6,
    defaultStartTime: '08:00',
    ...
    color: '#3b82f6',
    description: 'Turno contínuo de 6 horas sem intervalo prolongado, ideal para caixas em regime de rotatividade matinal ou vespertina.',
    appliesTo: 'all',
  },
  {
    id: 'shift-type-4h',
    name: 'Meio Turno / Part-Time (4 Horas)',
    code: 'T-4H',
    durationHours: 4,
    ...
    overtimeToleranceMinutes: 15,
    color: '#10b981',
    description: 'Turno parcial de 4 horas para reforço em períodos de maior afluência ou operadores em regime de meio período.',
    appliesTo: 'all',
  },
  {
    id: 'shift-type-12h',
    name: 'Turno Comercial Extensivo (12 Horas)',
    code: 'T-12H',
    durationHours: 12,
    defaultStartTime: '08:00',
    ...
    overtimeToleranceMinutes: 30,
    color: '#f59e0b',
    description: 'Jornada prolongada de 12 horas para restauração, eventos especiais, lojas de conveniência ou regime de escala 12x36.',
    appliesTo: 'all',
  },
  {
    id: 'shift-type-night',
    name: 'Turno Noturno (8 Horas de Trabalho)',
    code: 'T-NOT8H',
    durationHours: 8,
    ...
    overtimeToleranceMinutes: 30,
    color: '#8b5cf6',
    description: 'Turno noturno padrão de 8 horas com regime especial de operação noturna.',
    appliesTo: 'all',
  },
  {
    id: 'shift-type-flex',
    name: 'Turno Flexível / Sem Limite Fixo',
    code: 'T-FLEX',
    durationHours: 0,
    defaultStartTime: '08:00',
    ...
    breakMinutes: 0,
    isDefault: false,
    alertOnOvertime: false,
    overtimeToleranceMinutes: 0,
    color: '#6b7280',
    description: 'Turno livre sem limite fixo de horas. O encerramento e emissão do Relatório Z ocorrem livremente conforme necessidade.',
    appliesTo: 'all',
  },
];
