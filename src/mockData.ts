...
export const initialCompanies: Company[] = [
  {
    ...
    currencyDecimals: 2,
    phone: '+258 87 262 7974',
    email: 'contacto@raffa.mz',
    website: 'www.raffa.mz',
    logoUrl: '',
    softwareCertNumber: '4120/AT',
    saftVersion: '1.04_01',
    shareCapital: '100.000,00 MZN',
    commercialRegistryNumber: '10045/2023',
    defaultIban: 'MZ59000100000012345678901',
    defaultBank: 'Millennium BIM',
    ...
    subscriptionExpiresAt: new Date(Date.now() + 24 * 24 * 60 * 60 * 1000).toISOString(),
    subscriptionStartedAt: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(),
    plan: 'Plano Profissional Empresarial',
  },
];
...
export const defaultPermissionsByRole: Record<Role, UserPermissions> = {
  ...
  caixa: {
    pos: { read: true, create: true, edit: true, delete: false, fiscal: true },
    ...
    crm: { read: true, create: true, edit: true, delete: false, fiscal: false },
